...
public class HaskellShelleyModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public final void transactionBuilderNew(String linearFee, String minimumUtxoVal, String poolDeposit, String keyDeposit, Integer maxOutputSize, Integer maxTxSize, Promise promise) {
        Native.I
                .transactionBuilderNew(new RPtr(linearFee), new RPtr(minimumUtxoVal), new RPtr(poolDeposit), new RPtr(keyDeposit), maxOutputSize, maxTxSize)
                .map(RPtr::toJs)
                .pour(promise);
    }
