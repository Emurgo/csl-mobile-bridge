...
public class HaskellShelleyModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public final void auxiliaryDataPreferAlonzoFormat(String self, Promise promise) {
        Native.I
            .auxiliaryDataPreferAlonzoFormat(new RPtr(self))
            .pour(promise);
    }

    @ReactMethod
    public final void auxiliaryDataSetPreferAlonzoFormat(String self, Boolean prefer, Promise promise) {
        Native.I
            .auxiliaryDataSetPreferAlonzoFormat(new RPtr(self), prefer)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void bigNumMaxValue( Promise promise) {
        Native.I
            .bigNumMaxValue()
            .map(RPtr::toJs)
            .pour(promise);
    ...
    @ReactMethod
    public final void fixedTransactionToBytes(String self, Promise promise) {
        Native.I
            .fixedTransactionToBytes(new RPtr(self))
            .map(bytes -> Base64.encodeToString(bytes, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionFromBytes(String bytes, Promise promise) {
        Native.I
            .fixedTransactionFromBytes(Base64.decode(bytes, Base64.DEFAULT))
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionToHex(String self, Promise promise) {
        Native.I
            .fixedTransactionToHex(new RPtr(self))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionFromHex(String hexStr, Promise promise) {
        Native.I
            .fixedTransactionFromHex(hexStr)
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionNew(String rawBody, String rawWitnessSet, Boolean isValid, Promise promise) {
        Native.I
            .fixedTransactionNew(Base64.decode(rawBody, Base64.DEFAULT), Base64.decode(rawWitnessSet, Base64.DEFAULT), isValid)
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionNewWithAuxiliary(String rawBody, String rawWitnessSet, String rawAuxiliaryData, Boolean isValid, Promise promise) {
        Native.I
            .fixedTransactionNewWithAuxiliary(Base64.decode(rawBody, Base64.DEFAULT), Base64.decode(rawWitnessSet, Base64.DEFAULT), Base64.decode(rawAuxiliaryData, Base64.DEFAULT), isValid)
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionBody(String self, Promise promise) {
        Native.I
            .fixedTransactionBody(new RPtr(self))
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionRawBody(String self, Promise promise) {
        Native.I
            .fixedTransactionRawBody(new RPtr(self))
            .map(bytes -> Base64.encodeToString(bytes, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionSetBody(String self, String rawBody, Promise promise) {
        Native.I
            .fixedTransactionSetBody(new RPtr(self), Base64.decode(rawBody, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionSetWitnessSet(String self, String rawWitnessSet, Promise promise) {
        Native.I
            .fixedTransactionSetWitnessSet(new RPtr(self), Base64.decode(rawWitnessSet, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionWitnessSet(String self, Promise promise) {
        Native.I
            .fixedTransactionWitnessSet(new RPtr(self))
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionRawWitnessSet(String self, Promise promise) {
        Native.I
            .fixedTransactionRawWitnessSet(new RPtr(self))
            .map(bytes -> Base64.encodeToString(bytes, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionSetIsValid(String self, Boolean valid, Promise promise) {
        Native.I
            .fixedTransactionSetIsValid(new RPtr(self), valid)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionIsValid(String self, Promise promise) {
        Native.I
            .fixedTransactionIsValid(new RPtr(self))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionSetAuxiliaryData(String self, String rawAuxiliaryData, Promise promise) {
        Native.I
            .fixedTransactionSetAuxiliaryData(new RPtr(self), Base64.decode(rawAuxiliaryData, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionAuxiliaryData(String self, Promise promise) {
        Native.I
            .fixedTransactionAuxiliaryData(new RPtr(self))
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void fixedTransactionRawAuxiliaryData(String self, Promise promise) {
        Native.I
            .fixedTransactionRawAuxiliaryData(new RPtr(self))
            .map(bytes -> Base64.encodeToString(bytes, Base64.DEFAULT))
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void mintBuilderGetRefInputs(String self, Promise promise) {
        Native.I
            .mintBuilderGetRefInputs(new RPtr(self))
            .map(RPtr::toJs)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void networkInfoTestnetPreview( Promise promise) {
        Native.I
            .networkInfoTestnetPreview()
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void networkInfoTestnetPreprod( Promise promise) {
        Native.I
            .networkInfoTestnetPreprod()
            .map(RPtr::toJs)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void plutusWitnessNewWithRefWithoutDatum(String script, String redeemer, Promise promise) {
        Native.I
            .plutusWitnessNewWithRefWithoutDatum(new RPtr(script), new RPtr(redeemer))
            .map(RPtr::toJs)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void transactionBatchLen(String self, Promise promise) {
        Native.I
            .transactionBatchLen(new RPtr(self))
            .map(Utils::boxedLongToDouble)
            .pour(promise);
    }

    @ReactMethod
    public final void transactionBatchGet(String self, Double index, Promise promise) {
        Native.I
            .transactionBatchGet(new RPtr(self), index.longValue())
            .map(RPtr::toJs)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void transactionBatchListLen(String self, Promise promise) {
        Native.I
            .transactionBatchListLen(new RPtr(self))
            .map(Utils::boxedLongToDouble)
            .pour(promise);
    }

    @ReactMethod
    public final void transactionBatchListGet(String self, Double index, Promise promise) {
        Native.I
            .transactionBatchListGet(new RPtr(self), index.longValue())
            .map(RPtr::toJs)
            .pour(promise);
    }
    ...
    @ReactMethod
    public final void vkeywitnessesToBytes(String self, Promise promise) {
        Native.I
            .vkeywitnessesToBytes(new RPtr(self))
            .map(bytes -> Base64.encodeToString(bytes, Base64.DEFAULT))
            .pour(promise);
    }

    @ReactMethod
    public final void vkeywitnessesFromBytes(String bytes, Promise promise) {
        Native.I
            .vkeywitnessesFromBytes(Base64.decode(bytes, Base64.DEFAULT))
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void vkeywitnessesToHex(String self, Promise promise) {
        Native.I
            .vkeywitnessesToHex(new RPtr(self))
            .pour(promise);
    }

    @ReactMethod
    public final void vkeywitnessesFromHex(String hexStr, Promise promise) {
        Native.I
            .vkeywitnessesFromHex(hexStr)
            .map(RPtr::toJs)
            .pour(promise);
    }

    @ReactMethod
    public final void vkeywitnessesToJson(String self, Promise promise) {
        Native.I
            .vkeywitnessesToJson(new RPtr(self))
            .pour(promise);
    }

    @ReactMethod
    public final void vkeywitnessesFromJson(String json, Promise promise) {
        Native.I
            .vkeywitnessesFromJson(json)
            .map(RPtr::toJs)
            .pour(promise);
    }
