...
final class Native {
    ...
    public final native Result<RPtr> transactionBuilderNew(RPtr linearFee, RPtr minimumUtxoVal, RPtr poolDeposit, RPtr keyDeposit, long maxValueSize, long maxTxSize);
